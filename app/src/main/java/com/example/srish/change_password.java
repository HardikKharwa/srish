        ...
        _chgpass_btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!newPassword.equals(confirmPassword)){
                    _chgpass_etl_confirmPass.setError("New Password and Confirm Password doesn't match");
                    _chgpass_etl_confirmPass.requestFocus();
                    return;
                }
                else{
                ...
                if(cursor.getCount() == 0){
                    ...
                    if(cursor.moveToFirst()){
                        if(currentPassword.equals(cursor.getString(4))){
                            ...
                            Toast.makeText(change_password.this, "Current Password doesn't match, Try Again!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
