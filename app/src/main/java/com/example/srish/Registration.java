...
public class Registration extends AppCompatActivity {
    ...
    public void registerData(View view){
        ...
        if (username.isEmpty()) {
            ...
            _registration_etl_username.setEnabled(false);
        }
        if (password.isEmpty()) {
            ...
            _registration_etl_password.setEnabled(false);
        }
        ...
        if (email.isEmpty()) {
            ...
            _registration_etl_email.setEnabled(false);
        }
        if (contact.isEmpty()) {
            ...
            _registration_etl_contact.setEnabled(false);
        }
        if (contact.length() != 10) {
            _registration_etl_contact.setError("Contact must be 10 digits");
            _registration_et_contact.requestFocus();
            return;
        } else {
